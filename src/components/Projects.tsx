...
export const Projects = () => {
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className={`relative bg-[#040C09] overflow-hidden min-h-screen flex flex-col reveal-trigger ${sectionInView ? 'visible' : ''}`}
    >
        ...
        <AnimatePresence initial={true} custom={dir}>
          {sectionInView && (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#020806] via-[#020806]/40 to-transparent" />
              <div className="absolute inset-0 bg-gradient-to-r from-[#020806]/90 via-transparent to-transparent" />
            </motion.div>
          )}
        </AnimatePresence>
      </div>
      ...
      <div className="relative z-10 flex flex-col justify-between h-screen px-10 md:px-20 pt-10 pb-16">
        ...
        <div className="pj-entrance-top flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <span className="font-mono text-[12px] tracking-[0.4em] uppercase text-[#10B981]">Selected Work</span>
          </div>
        ...
        <div className="max-w-4xl">
          <div className="overflow-hidden mb-4 pj-entrance-cat">
            <motion.p
              ...
              className="font-mono text-[14px] tracking-[0.3em] uppercase text-[#10B981]"
            >
          ...
          <div className="max-w-xl pj-entrance-content">
            ...
            <div className="flex flex-wrap gap-3 mb-12">
              {project.techs.map((tech) => (
                <span key={tech} className="font-mono text-[11px] tracking-[0.2em] uppercase px-4 py-2 border border-[#10B981]/30 bg-[#10B981]/5 text-[#F8F4F0]/90">
                  {tech}
                </span>
              ))}
            </div>
        ...
        <div className="pj-entrance-bottom flex items-end justify-between">
          <div className="flex gap-4">
            <button onClick={goPrev} className="w-14 h-14 border border-white/10 flex items-center justify-center hover:bg-[#10B981]/10 hover:border-[#10B981]/40 transition-all duration-400 group">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-white/40 group-hover:text-[#10B981] transition-colors">
                <path d="M15 18l-6-6 6-6" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </button>
            <button onClick={goNext} className="w-14 h-14 border border-white/10 flex items-center justify-center hover:bg-[#10B981]/10 hover:border-[#10B981]/40 transition-all duration-400 group">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-white/40 group-hover:text-[#10B981] transition-colors">
      ...
      <div className="pj-entrance-num absolute top-1/2 right-12 md:right-24 -translate-y-1/2 pointer-events-none select-none z-[-1]">
        <span className="font-display font-black text-[#10B981]/5 text-[clamp(180px,25vw,400px)] leading-[0.7] tracking-tighter">
          {project.index}
        </span>
      </div>
